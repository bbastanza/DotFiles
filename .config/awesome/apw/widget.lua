...
local width         = 50        -- width in pixels of progressbar
local margin_right  = 7         -- right margin in pixels of progressbar
local margin_left   = 7         -- left margin in pixels of progressbar
local margin_top    = 11         -- top margin in pixels of progressbar
local margin_bottom = 11         -- bottom margin in pixels of progressbar
local step          = 0.04      -- stepsize for volume change (ranges from 0 to 1)
local color         = '#6AF1FF' -- foreground color of progessbar
local color_bg      = '#377E86' -- background color
local color_mute    = '#FF8587' -- foreground color when muted
local color_bg_mute = '#924849' -- background color when muted
